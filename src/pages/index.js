...
export default function Home() {
  ...
  return (
    ...
    >
      <div
        className={`text-center goudy text-[32px] md:text-[26px]  ${customStyles.verticalSpacing.sm} ${customStyles.verticalSpacing.md} ${customStyles.verticalSpacing.lg} `}

      >
        <div className="space-y-[0px]">
          <h1 className="font-bold text-[36px] md:text-[42px] m-[0px] pt-[0px]">BOB SLAYMAKER</h1>
          <h1 className=" text-[36px] md:text-[42px] p-[0px]" style={{fontVariant: "small-caps"}}>Writer-Filmmaker</h1>
        </div>
