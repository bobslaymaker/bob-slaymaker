...
const CV = () => {
    return (
        <div className="goudy flex justify-center w-full text-[21px]">
            ...
            <h6 className="goudy text-[32px] uppercase text-center mt-10"><b/>CURRICULUM VITAE<b/></h6>
                ...
                <div className="spacer"></div>
                Among the magazines, newspapers and literary reviews that have published my
                poems, essays and short stories are The Christian Science Monitor, African
                American Review, The Malahat Review, Poetry Ireland Review, River Styx, The US
                Latino Review, The Texas Observer, The North American Review, and Essence.
                <div className="spacer"></div>
                ...
                <div className="spacer"></div>
                “Acid Trip,” “Player” and “Fool” (poems), African American Review, Volume 36,
                Number 2 (Summer 2002).
                <div className="spacer"></div>
                “Appetite” (poem), The Christian Science Monitor, June 12, 2002.
                <div className="spacer"></div>
                “Menstruation” (poem), 3 AM Magazine, June 2002.
                <div className="spacer"></div>
                ...
                <div className="spacer"></div>
                “Rat Race” (poem), New York Quarterly, Number 57.
                <div className="spacer"></div>
                “Yearning” (poem), The Orlando Times, August 13, 1998.
                <div className="spacer"></div>
                “America’s Ode to the Aged” (poem), Free Lunch (Number 20) (1998).
                <div className="spacer"></div>
                ...
                <div className="spacer"></div>
                “Exile” (poem), Drumvoices Review, Volume 6, Numbers 1 & 2.
                <div className="spacer"></div>
                “Small Flowers of the Earth” and “This Part” (poems), Highbeams, Spring 1997.
                <div className="spacer"></div>
                “Le Fou” (poem), Callaloo, Volume 19, Number 4.
                <div className="spacer"></div>
                “Not Until the Leaders Are Gone” (poem), San Fernando Poetry Journal, Vol. XIX,
                #3 (1997).
                <div className="spacer"></div>
                “The Magic Wand” (short story), The New Voices, May, 1997.
                <div className="spacer"></div>
                “Family Gathering” (poem), phati’tude, Spring 1997.
                <div className="spacer"></div>
                “Bay Poem” (poems), Wohnzimmer (Germany), Issue 14, Winter 1996.
                <div className="spacer"></div>
                “Death at Nineteen” (poem), Flipside, January/February 1997.
                <div className="spacer"></div>
                “Of Bright Things To Come” (poem), GO! Poetry, March 1997.
                <div className="spacer"></div>
                “Dancing with the Sun” and “Cabdriver in the City of Thieves” (poems), Poetry
                Magazine, March 1997.
                <div className="spacer"></div>
                “Blessed Are the Unborn, for They Are Worth More Than the Living (Particularly
                If the Living Are Women)” (poem), Street News, First Issue 1997.
                <div className="spacer"></div>
                “A House of People” (poem), Interrace Magazine (Issue #37), February 1997.
                <div className="spacer"></div>
                “Poem for the Planet” (poem), The Christian Science Monitor, November 4, 1996
                (reprinted in Paterson Literary Review, Issue 27 (1998).
                <div className="spacer"></div>
                “Foundations My Father Didn’t Lay in the Home Not Yet Designed” (poem), Street
                News, No. 4, 1996.
                <div className="spacer"></div>
                “Grandfather” (poem), The Rio Grande Review, Volume XV, No. 11.
                <div className="spacer"></div>
                “A Brief Visit with Bernhard Goetz” (poem), Street News, 3rd Issue, 1996.
                <div className="spacer"></div>
                ...
                <div className="spacer"></div>
                Cornelia Street Café, New York, NY (May 2005).
                <div className="spacer"></div>
                KGB Bar, New York, NY (January 2005).
                <div className="spacer"></div>
                The Telephone Bar, New York, NY (October 2004).
                <div className="spacer"></div>
                ...
                <div className="spacer"></div>
                Cornelia Street Café, New York, NY (March 2002).
                <div className="spacer"></div>
                KGB Bar, New York, NY (February 2002).
                <div className="spacer"></div>
                Cornelia Street Café, New York, NY (December 2001).
                <div className="spacer"></div>
                Living Room, New York, NY (Winter 2001).
                <div className="spacer"></div>
                KGB Bar, New York, NY (October 2001).
                <div className="spacer"></div>
                Tribes Gallery, New York, NY (June 2001).
                <div className="spacer"></div>
                ...
                <div className="spacer"></div>
                York College, Jamaica, NY (November 1999).
                <div className="spacer"></div>
                Knitting Factory, New York, NY (Fall 1998).
                <div className="spacer"></div>
                Borders, New York, NY (June 1997).
                <div className="spacer"></div>
                Langston Hughes Cultural Center, Corona, NY (April 1997).
                <div className="spacer"></div>
                Barnes & Noble, New York, NY (January 1997).
                <div className="spacer"></div>
                Nuyorican Poet’s Café, New York, NY (April 1996).
                <div className="spacer"></div>
                Webster Public Library, New York, NY (March 1995).
                <div className="spacer"></div>
