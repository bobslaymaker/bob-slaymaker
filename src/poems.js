export const poems = [  
    {
        title: "Appetite", 
        content:  <p><bold> <h6 className="text-center m-0 p-0"> APPETITE </h6></bold><div className="spacer"></div>
        ...
        she’d urge me to join my sleeping siblings soon.<div className="spacer"></div>
        
        After her visit, my appetite always vanished,<br/>
        and slipping under the covers<br/>
        I felt loved enough to sleep.<div className="spacer"></div><br/>
...
They sit, <br/>laugh, <div className="spacer"></div>collaborate <br/>on poems, <div className="spacer"></div>and argue <br/>over how <div className="spacer"></div>to split <br/>the millions.<div className="spacer"></div>***<div className="spacer"></div>“I’m fed up<br/>with this<br/>poem,” Pete<div className="spacer"></div>says.  “You<br/>finish it.”<br/>“O.K.,” says<div className="spacer"></div>Tom.  “Then<br/><i>I</i> get all<br/>the money.”<div className="spacer"></div><br/>
        ...
        title: "Bad Attitude", 
        content: 
        <p><semi-bold>    <h6 className="text-center m-0 p-0">    BAD ATTITUDE </h6></semi-bold><div className="spacer"></div>
        ...
        the cold work yard.<div className="spacer"></div><br/>
        <i>Originally published in </i>Downtown Brooklyn</p>

    },
    {
        title: "The Beach Towel", 
        content:  <p><bold> <h6 className="text-center m-0 p-0">THE BEACH TOWEL </h6></bold><div className="spacer"></div>Under this comforter my love and I rest,<br/>beneath the comforter her brown beach towel<br/>covering her from head to toe.<br/>She’s slept this way for years, she says,<br/>this Linus blanket for extra warmth<br/>and, I suppose, for extra love.<div className="spacer"></div>Lying beside her, I say:<br/>“Take that damn towel off.<br/>You’re twenty–four years old, for Christ’s sake.<br/>You’ve got me, why do you need<br/>that stupid towel?”<div className="spacer"></div>She keeps it on her, snuggling happily.<div className="spacer"></div>I persist:  “You don’t need that towel.<br/>You’ve got me.  You act like a child<br/>with that thing.  C’mon, take it off.”<div className="spacer"></div>She turns over, tightly clutching<br/>her warm brown towel.<div className="spacer"></div>I try pulling it off her.<br/>She grips it tightly.<br/>I pull <i>really</i>, <i>really</i> hard.<br/>She holds on.<div className="spacer"></div>Tired of struggling,<br/>I move under the towel and into her arms.<br/>I kiss her eyelid.<br/>The hell with it, I think.<br/>You’ll just share her with this stupid towel.<div className="spacer"></div>I hold her close,<br/>feeling good in her arms, in her life.<br/>She—not where we live—<br/>is my home, <br/>and I want to be with her forever.<div className="spacer"></div>Now she moves deeper into our embrace,<br/>and the brown towel, like a magic carpet, <br/>floats out from under the comforter<br/>and flies away.<div className="spacer"></div><br/>
          ...
          
    {
        ...
        content: <p><semi-bold> <h6 className="text-center m-0 p-0"> ALL–AMERICAN IRISH KID,
        QUEENS, NEW YORK, 1968 </h6> </semi-bold><div className="spacer"></div>
        ...
        The words “Krauts,” “Sieg Heil!” and “Nazis” were.<div className="spacer"></div>
        
        On her knees scrubbing,<br/>
        my beautiful young mother rose,<br/>
        with a silent sigh switched off the radio.<div className="spacer"></div><br/>
        <i>Originally published in </i>Home Planet News <i></i>and<i/> Melic Review</p>
    },    
{
    title: "The D Train",
    content: <p><semi-bold> <h6 className="text-center m-0 p-0"> THE D TRAIN </h6></semi-bold><div className="spacer"></div>Alone and depressed in my SRO room,<br/>I slap myself, jump up and dress,<br/>lock the door behind me.  I skip down<br/>to the underground, where a brightly lit D train<br/>awaits me.  I sit among Tom, Dick and Harry,<br/>among Lawanda, Sung Kim, and Juan.<br/>Some read the papers, others department–store flyers.<br/>Sons talk to mothers, sisters talk to cousins,<br/>kids chase each other down the aisle.  I feel good<br/>among the many, the young, the old,<br/>neighbors, strangers, friends, families,<br/>all of us sharing this highway of people,<br/>riding toward a common future.</p>
},    

    {
        title: "Yearning", 
        content:  <p><semi-bold><h6 className="text-center m-0 p-0">YEARNING</h6></semi-bold><div className="spacer"></div>

They lived in a crowded, single–story house,<br/>six kids, two parents, one grandmother.<br/>The three boys slept in one bedroom,<br/>the three girls in another.<br/>The parents had their room,<br/>the grandmother hers.<div className="spacer"></div>
There was never a peaceful moment,<br/>the bathroom the only refuge<br/>before someone pounded the door,<br/>stopping a boy’s mirrored boxing match,<br/>a girl’s imagined ballet. <div className="spacer"></div>

Thirty years later, each lives alone,<br/>relishing the quiet, the privacy,<br/>missing the varied human voices,<br/>the many hearts beating as one. <div className="spacer"></div><br/>
        
<i>Originally published in </i>The Orlando Times </p>
        },
        {
                title: "Love", 
                content:  <p><semi-bold><h6 className="text-center m-0 p-0">LOVE</h6></semi-bold><div className="spacer"></div>
            ...
            },
    {
        title: "Menstruation",
        content:
        <p><semi-bold><h6 className="text-center m-0 p-0">MENSTRUATION</h6></semi-bold><div className="spacer"></div>
        ...
        her angry, ashamed reply when he asked why.<div className="spacer"></div>
    ...
    },
    {
        ...
        content: 
        <p><semi-bold><h6 className="text-center m-0 p-0">ST. MEL’S, SECOND GRADE</h6></semi-bold><div className="spacer"></div>
...
saw Roseanne giggling and smiling and laughing.<div className="spacer"></div>

And Sister Grace marched down the aisle<br/>
between our miniature desks,<br/>
and smacked the shit out of little Roseanne.<div className="spacer"></div>

And that wiped the smile off Roseanne’s face,<br/>
and ended her giggling and laughing too.<div className="spacer"></div><br/>
        <i>Originally published in </i>Windsor Review
</p>
    },
    {
        title: "My Wife Breaks Out", 
        content:  <p><semi-bold><h6 className="text-center m-0 p-0">MY WIFE BREAKS OUT</h6></semi-bold><div className="spacer"></div>This afternoon she flashed me,<br/>she who’s always been so shy,<br/>perfect circles of softness<br/>staring at my face, then gone,<br/>hidden beneath her sweater.<div className="spacer"></div>I just smiled.<br/>It was the middle of the day,<br/>her flash an interruption,<br/>a suggestion she’s leaving her room,<br/>full–force, unchained,<br/>ready to take the world by surprise.<div className="spacer"></div><br/>
        <i>Originally published in </i>La Petite Zine <i>and</i> Forever in Love</p>
    },        
    {
        title: "Repulsive", 
        content:  <p><semi-bold><h6 className="text-center m-0 p-0">REPULSIVE</h6></semi-bold><div className="spacer"></div>A guy coming into the bathroom, I’m going out—<br/>we squeeze past each other in the doorway,<br/>and he cowers a little, a frail, frightened doe;<br/>the bully in me, shaped by a trillion glossy images,<br/>
